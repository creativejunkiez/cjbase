		...
		<div class="container">
			<div class="col-md-12 activity-drafts">
				<ul class="nav nav-pills">
					<li class="active"><a href="{{URL::route('userDashboard',$name = $userdel->name)}}">Posts</a></li>
					<li><a href="{{URL::route('userActivity',$name = $userdel->name)}}" class="active">Activity</a></li>
				</ul>
			</div>
		</div>
	</div>
