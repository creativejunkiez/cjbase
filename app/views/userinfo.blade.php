...
?>
	...
	<div class="row featured-post" id="postswrapper">
		<div class="container">
			<div class="col-md-8 col-sm-12 top-slider-image" id="loadmoreajaxloader">
				...
				@else
				   <img width="800" height="500" id="img" src="{{asset('assets/img/1.png')}}"></img>
				@endif
					<div class="top-slider-image-caption">
...
<div class="container">
<div class="col-md-6 col-sm-5 col-xs-6 first-column">
<?php 
...
?>
				<div class="row post">
					<div class="col-md-3 col-sm-12 post-img">
						@if($addlin->thumbnail)
						<a href="{{ URL::route('postdata', array('postid' => $postid)) }}" >
   						 <img width="115" height="76" id="img" src="{{asset('thumbnails')}}/{{$addlin->thumbnail}}"></img>
						</a>
						@else
						   <img width="115" height="76" id="img" src="{{asset('assets/img/1.png')}}"></img>
						@endif
...
<div class="col-md-4 col-sm-4 col-xs-6 second-column">
<?php 
...
?>
				<div class="row second-column-post">
					<div class="col-md-12 col-sm-12 po-img">
						@if($addlin->thumbnail)
						<a href="{{ URL::route('postdata', array('postid' => $postid)) }}" >
				...
				<div class="row third-column-post">
					<div class="col-md-12 third-column-post-img">
						...
						<div class="third-column-post-img-caption">
							<p><a href="{{ URL::route('postdata', array('postid' => $postid)) }}" >{{$title}}</a></p>
						</div>
					</div>
				</div>
<?php } ?>
